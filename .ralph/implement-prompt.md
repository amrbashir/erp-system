...
2. Include task completed with GitHub auto close keyword + PRD reference
3. If PRD which closing the issue would complete, add GitHub auto close keyword for it too.
