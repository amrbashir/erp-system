...
describe("Currency utilities", () => {
  describe("toBaseUnits", () => {
    ...
    it("should round to nearest base unit", () => {
      expect(toBaseUnits(1.234)).toBe(123);
      expect(toBaseUnits(1.235)).toBe(124);
      expect(toBaseUnits(1.2345)).toBe(123);
      expect(toBaseUnits(1.2351)).toBe(124);
    });
  });
  ...
  describe("formatCurrency", () => {
    it("should format currency values correctly for Egyptian locale", () => {
      ...
      const formatted = formatCurrency(15050, "EGP", "ar-EG");
